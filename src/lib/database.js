...
const POSTGRES_CAMEL_CASE_KEYS = [
  ...
  'timedOut', 'searchFallback', 'browserEngine', 'browserEngineFallback', 'searchCount', 'lastSearchedAt', 'canonicalName',
...
export async function saveQuoteResult(result) {
  ...
  await dbInstance.run(
    `INSERT INTO QuoteResult (
      ...
      browserEngine, browserEngineFallback,
    ...
    result.browserEngine || null,
    result.browserEngineFallback || null,
