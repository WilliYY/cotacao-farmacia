...
- **Seleção Exata da Tabela de Busca (`Find-TableControl`):** O robô agora diferencia a tabela do **Carrinho de Pedidos** (17 colunas, coluna 0 botão lixeira ``) da tabela de **Resultados da Busca** (18 colunas, coluna 0 código EAN de 13 dígitos).
